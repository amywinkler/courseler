...
export let getDepartmentColor = (department) => {
  ...
  let humanities = new Set(["Classics","Comparative Literature","Contemplative Studies","Education","English","Gender and Sexuality Studies","Literary Arts", "History of Art and Architecture","Humanities","Music","Philosophy","Religious Studies","Theatre Arts and Performance Studies","Visual Art"]);
